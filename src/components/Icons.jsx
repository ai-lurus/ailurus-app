// Heroicons v2 outline — 24x24 viewBox, strokeWidth="1.5"
...
export function ManageIcon({ className = 'w-5 h-5' }) {
  return (
    <svg className={className} {...base}>
...
export function LearningIcon({ className = 'w-5 h-5' }) {
  return (
    <svg className={className} {...base}>
...
export function SprintIcon({ className = 'w-5 h-5' }) {
  return (
    <svg className={className} {...base}>
...
export function BoardIcon({ className = 'w-5 h-5' }) {
  return (
    <svg className={className} {...base}>
